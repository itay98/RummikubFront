...
export function GRPOT(props) {
    return (<OlT transition={false} placement="top" trigger="click" overlay={<Po className={rules}>
        <Po.Title as="h6">Game Rules in short</Po.Title><Po.Content>
            Be the first to empty your rack by placing your tiles as sets on the board.<br />
            Click a tile to toggle selection. Click an empty slot to transfer selected tiles.<br />
            ...
            of any tile, or two tiles as a penalty if you left an invalid board. All tiles successfully placed on the board must
            remain there.<br />
