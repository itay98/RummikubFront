...
export default function Home() {
    return <div className={cont}><div></div>
        <p>Rummikub is one of the most popular games in the world. It was developed by the late Mr. Ephraim Hertzano back in
        the 50’s. Nowadays Rummikub is sold in over 70 countries and translated into 28 languages.</p>
